...
function genesis_theme_settings_boxes() {
	...
	add_meta_box('genesis-theme-settings-author-box', __('Author Box', 'genesis'), 'genesis_theme_settings_author_box', $_genesis_theme_settings_pagehook, 'column2');
...
function genesis_theme_settings_feeds_box() { ?>
	...
	<p><span class="description"><?php printf( __('<b>NOTE:</b> If your custom feed(s) are not handled by Feedburner, we do not recommend that you use the redirect options. They will not work properly.') ); ?></span></p>
...
function genesis_theme_settings_author_box() { ?>
	<p>
	<input type="checkbox" name="<?php echo GENESIS_SETTINGS_FIELD; ?>[author_box_single]" id="<?php echo GENESIS_SETTINGS_FIELD; ?>[author_box_single]" value="1" <?php checked(1, genesis_get_option('author_box_single')); ?> /> <label for="<?php echo GENESIS_SETTINGS_FIELD; ?>[author_box_single]"><?php _e('Enable Author Box on Single Posts', 'genesis'); ?></label>	
	</p>
